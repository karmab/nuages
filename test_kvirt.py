...
print k.create(name2, clu, numcpu, numinterfaces, netinterface, diskformat1, disksize1, diskinterface,memory, storagedomain, guestid, net1, net2=net2, net3=net3, net4=net4, iso=iso, diskformat2=diskformat2, disksize2=disksize2,vnc=vnc)
print k.start(name2)
