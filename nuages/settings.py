...
DATABASES = {
    'default': {
        ...
        'NAME': 'nuages',                      # Or path to database file if using sqlite3.
        'USER': 'nuages',                      # Not used with sqlite3.
        'PASSWORD': 'nuages',                  # Not used with sqlite3.
...
SECRET_KEY = '^=#lx_1szl5%c(*2cpbqb95f*q$bu+)*%f2!5jt)h@z&amp;mvp9ly'
